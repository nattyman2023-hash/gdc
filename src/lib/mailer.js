...
function getTransport(config) {
  ...
  try {
    ...
    transporter = nodemailer.createTransport({
      ...
      // Email content is generated by this application, never by an
      // untrusted message object. Keep both switches enabled anyway so a
      // future attachment/path or URL cannot make the SMTP transport read
      // local files or perform server-side fetches.

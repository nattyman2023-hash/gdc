  ...
  await knex('news_posts').insert([
    {
      ...
      image_url: '/img/generated/gdcu-news-intake-male-home-v2.png',
      published: true,
      published_at: day(28),
    },
    {
      ...
      image_url: '/img/generated/gdcu-news-program-female-home-v2.png',
      published: true,
      published_at: day(20),
    },
    {
      ...
      image_url: '/img/generated/gdcu-news-accreditation-park-v2.png',
      published: true,
      published_at: day(12),
    },
    {
      ...
      image_url: '/img/generated/gdcu-program-theology-living-room-v2.png',
      published: true,
      published_at: day(5),
    },
  ]);
